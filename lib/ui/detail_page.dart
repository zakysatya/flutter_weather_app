                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(getForecastWeather(0)["maxTemp"].toString(), style: TextStyle(
                                      fontSize: 80,
                                                  ...
                                                  Row(
                                                    children: [
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(0)["minTemp"].toString(),
                                                            style: TextStyle(
                                                      ...
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(0)["maxTemp"].toString(),
                                                            style: TextStyle(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Text('${getForecastWeather(0)['chanceOfRain']}%', style: const TextStyle(
                                                          fontSize: 18,
                                                          color: Colors.grey
                                                      ),),
                                                      const SizedBox(width: 5,),
                                                  ...
                                                  Row(
                                                    children: [
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(1)["minTemp"].toString(),
                                                            style: TextStyle(
                                                              color: _constants.greyColor,
                                                              fontSize: 30,
                                                              fontWeight: FontWeight.w600,
                                                      ...
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(1)["maxTemp"].toString(),
                                                            style: TextStyle(
                                                              color: _constants.blackColor,
                                                              fontSize: 30,
                                                              fontWeight: FontWeight.w600,
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 5,),
                                                      Text(getForecastWeather(1)['weatherName'], style: TextStyle(
                                                          fontSize: 16,
                                                          color: Colors.grey
                                                      ),),
                                                    ],
                                                  ...
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Text('${getForecastWeather(1)['chanceOfRain']}%', style: const TextStyle(
                                                          fontSize: 18,
                                                          color: Colors.grey
                                                      ),),
                                                      const SizedBox(width: 5,),
                                                  ...
                                                  Row(
                                                    children: [
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(2)["minTemp"].toString(),
                                                            style: TextStyle(
                                                              color: _constants.greyColor,
                                                              fontSize: 30,
                                                              fontWeight: FontWeight.w600,
                                                      ...
                                                      Row(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          Text(getForecastWeather(2)["maxTemp"].toString(),
                                                            style: TextStyle(
                                                              color: _constants.blackColor,
                                                              fontSize: 30,
                                                              fontWeight: FontWeight.w600,
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 5,),
                                                      Text(getForecastWeather(2)['weatherName'], style: TextStyle(
                                                          fontSize: 16,
                                                          color: Colors.grey
                                                      ),),
                                                    ],
                                                  ...
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Text('${getForecastWeather(2)['chanceOfRain']}%', style: const TextStyle(
                                                          fontSize: 18,
                                                          color: Colors.grey
                                                      ),),
                                                      const SizedBox(width: 5,),
